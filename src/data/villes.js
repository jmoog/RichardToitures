...
export const villes = [
  ...
  // ──────────────────────────────────────────────────── SAINT-CYR-SUR-LOIRE ──
  {
    ...
    cards: [
      ...
      { href: "/recherche-de-fuite-toiture-saint-cyr-sur-loire/", icon: "/iconesprestations/reparation-toiture.png", title: "Recherche de fuite", text: "Ardoise glissée, solin ouvert, auréole au plafond : je remonte le cheminement de l'eau jusqu'au point d'entrée, puis je répare. En urgence, une bâche protège la maison le temps de la réparation." },
    ],
    cta: {
    ...
    longue: {
      ...
      paragraphs: [
        ...
        "L'entretien couvre aussi la zinguerie : curage des gouttières et des descentes, pose de crapaudines aux naissances pour retenir les feuilles, contrôle des soudures, vérification des solins et abergements autour des cheminées. C'est d'ailleurs un solin ouvert qui m'a valu, en juin 2026, une <a href=\"/recherche-de-fuite-toiture-saint-cyr-sur-loire/\">recherche de fuite au pied d'une cheminée</a> dans la commune — le récit du chantier est en ligne. Ces ouvrages en zinc font un travail silencieux mais décisif — tant qu'ils fonctionnent, les façades et les fondations restent au sec. Un compte rendu photographique vous est remis après l'intervention.",
  ...
  // ─────────────────────────────────────────────────────────────── FONDETTES ──
  {
    ...
    servicesTitle: "Ce que je fais pour votre toiture",
    cards: [
      { href: "/reparation-faitage-fondettes/", icon: "/iconesprestations/reparation-toiture.png", title: "Réparation de faîtage", text: "Faîtières qui bougent, mortier qui s'effrite, morceaux d'embarrures dans les gouttières : je rescelle ou remplace les éléments du faîtage, souvent dans la journée grâce au camion-nacelle." },
